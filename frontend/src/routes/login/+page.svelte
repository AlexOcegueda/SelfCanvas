...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    <p class="text-xs text-center text-gray-500 mb-2">Recruiter / Demo Mode:</p>
    <button 
        type="button"
        class="w-full bg-gray-800 text-white py-2 rounded hover:bg-black transition-colors font-medium text-sm flex items-center justify-center gap-2"
        on:click={() => {
            username = "guest";
